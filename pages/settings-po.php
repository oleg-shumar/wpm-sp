        ...
        <div class="main-content horizontal-content">
            <div class="page">
                ...
                <div class="container">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <h4><?php echo  __( 'Purchase Order Settings', QA_MAIN_DOMAIN ); ?></h4>
                            <p class="mg-b-20"></p>
                            <form method="post" enctype="multipart/form-data">
                                <p style="font-weight: bold; font-size: inherit"><?php echo  __( 'Here you can define the content and layout of your Purchase Orders.This information is included in the Purchase Order. If you do not wish to share this information, please leave blank.', QA_MAIN_DOMAIN ); ?></p>
                                <!-- begin new form -->
                                <div class="row" id="js-add-new-supplier">
                                    <div class="col-md-4 ">
                                        <label><?php echo  __( 'Company Name', QA_MAIN_DOMAIN ); ?>*</label> <input type="text" class="form-control" name="po-company-name" required="required" value="<?php echo  esc_attr( $po_company_name ); ?>" placeholder="Company Name*"/> <label><?php echo  __( 'Company Address', QA_MAIN_DOMAIN ); ?>*</label> <input type="text" class="form-control" name="po-company-address" required="required" value="<?php echo  esc_attr( $po_company_address ); ?>" placeholder="Company Address*"/> <label><?php echo  __( 'Postal Code', QA_MAIN_DOMAIN ); ?>*</label> <input type="text" class="form-control" name="po-postal-code" required="required" value="<?php echo  esc_attr( $po_postal_code ); ?>" placeholder="Postal Code*"/> <label><?php echo  __( 'City', QA_MAIN_DOMAIN ); ?>*</label> <input type="text" class="form-control" name="po-city" required="required" value="<?php echo  esc_attr( $po_city ); ?>" placeholder="City*"/> <label><?php echo  __( 'Country', QA_MAIN_DOMAIN ); ?>*</label> <input type="text" placeholder="Country*"/>
                                        <label><?php echo  __( 'Additional Information', QA_MAIN_DOMAIN ); ?></label> <textarea class="form-control" name="po-description" placeholder="Additional Information"><?php echo  esc_textarea( $po_description ); ?></textarea> <br>
                                    </div>
                                    <div class="col-md-4">
                                    ...
                                    <div class="col-md-4">
                                        <label><?php echo  __( 'Bank', QA_MAIN_DOMAIN ); ?></label> <input type="text" class="form-control" name="po-bank" value="<?php echo  esc_attr( $po_bank ); ?>" placeholder="Bank"/> <label><?php echo  __( 'Branch', QA_MAIN_DOMAIN ); ?></label> <input type="text" class="form-control" name="po-branch" value="<?php echo  esc_attr( $po_branch ); ?>" placeholder="Branch"/> <label><?php echo  __( 'Account Number', QA_MAIN_DOMAIN ); ?></label> <input type="text" class="form-control" name="po-account-number" value="<?php echo  esc_attr( $po_account_number ); ?>" placeholder="Account Number"/> <label><?php echo  __( 'Swift Code', QA_MAIN_DOMAIN ); ?></label> <input type="text" class="form-control" name="po-swift-code" value="<?php echo  esc_attr( $po_swift_code ); ?>" placeholder="Swift Code"/> <label><?php echo  __( 'IBAN', QA_MAIN_DOMAIN ); ?></label> <input type="text" class="form-control" name="po-iban" value="<?php echo  esc_attr( $po_iban ); ?>" placeholder="IBAN"/>
                                    </div>
                                </div>
                                <!-- end new form -->
                                <p style="font-weight: bold; font-size: inherit"><?php echo  __( 'Your purchase order numbers are set on auto-generate mode to save you time.', QA_MAIN_DOMAIN ); ?></p>
                                <p style="font-weight: bold; font-size: inherit"><?php echo  __( 'Do you want to change settings?', QA_MAIN_DOMAIN ); ?></p>
                                <table class="sp-settings-po-table">
                                    <tr>
                                        <th></th>
                                        <th><?php echo  __( 'Prefix', QA_MAIN_DOMAIN ); ?></th>
                                        <th><?php echo  __( 'Next Number', QA_MAIN_DOMAIN ); ?></th>
                                    </tr>
                                    <tr>
                                        <td style="width: 40%; text-align: left; font-weight: bold"><input type="radio" name="po-auto-generate" value="auto"
												<?php echo  $po_autogenerate_orders_type == 'auto' ? 'checked="checked"' : ''; ?>
                                            /><?php echo  __( 'Continue auto-generating purchase order numbers', QA_MAIN_DOMAIN ); ?>
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        <td colspan="3" style="text-align: left; font-weight: bold"><input type="radio" name="po-auto-generate" value="manual"
												<?php echo  $po_autogenerate_orders_type == 'manual' ? 'checked="checked"' : ''; ?>
                                            /><?php echo  __( 'I will add them manually each time', QA_MAIN_DOMAIN ); ?>
                                        </td>
                                    </tr>
                                </table>
                                <p class="mg-b-20"></p>
                                <input style="margin-top: 2em" type="submit" class="btn btn-sm
                                    btn-success" value="<?php echo  __( 'Save Settings', QA_MAIN_DOMAIN ); ?>" name="save-po-settings"/>
                            </form>
                        </div>
                    </div>
                </div>
