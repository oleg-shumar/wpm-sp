...
$step = 4;
?>
<h1 class="sphd-category"><?php echo  __( 'Success!', QA_MAIN_DOMAIN ); ?></h1>
<div style="width: 48%; text-align: left; position: relative; display: inline-block;
vertical-align: top; margin-top: 45px">
    <img style="position: relative; width: 90%" src="<?php echo  plugin_dir_url( __FILE__ ) ?>assets/shelf_planner_by_quick_assortments.png">
</div>
<div style="width: 51%; text-align: left; position: relative; display: inline-block"
     class="sphd-final-text">
    <p style="color: #486A82; font-weight: bold;"><?php echo  __( 'That’s it!', QA_MAIN_DOMAIN ); ?></p>
    ...
    <p><?php echo  __( 'By installing this plugin, you agree to Shelf Planner’s', QA_MAIN_DOMAIN ) ?> <a href="https://shelfplanner.com/terms-conditions/" target="_blank"><?php echo  htmlspecialchars( __( 'Terms & Conditions', QA_MAIN_DOMAIN ) ) ?></a></p>
    <button class="button-primary sphd-finish-button" onclick="complete_wizard(); return false"><?php echo  __( 'Complete Installation', QA_MAIN_DOMAIN ); ?></button>
</div>
